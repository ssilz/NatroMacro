...
settings["PepperBoosterCheck"] := {enum: 264, type: "int", section: "Boost", regex: "i)^(0|1)$"}
settings["StumpBoosterCheck"] := {enum: 265, type: "int", section: "Boost", regex: "i)^(0|1)$"}
settings["MPlanterHold1"] := {enum: 266, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPlanterHold2"] := {enum: 267, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPlanterHold3"] := {enum: 268, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["BrownQuestCheck"] := {enum: 269, type: "int", section: "Quests", regex: "i)^(0|1)$"}
settings["LastBrownQuest"] := {enum: 270, type: "int", section: "Quests", regex: "i)^\d{1,10}$"}
settings["StickerStackCheck"] := {enum: 271, type: "int", section: "Boost", regex: "i)^(0|1)$"}
settings["LastStickerStack"] := {enum: 272, type: "int", section: "Boost", regex: "i)^\d{1,10}$"}
settings["StickerStackMode"] := {enum: 273, type: "int", section: "Boost", regex: "i)^(0|1)$"}
settings["StickerStackTimer"] := {enum: 274, type: "int", section: "Boost", regex: "i)^(?!0)(?:9\d\d|\d{4}|[1-7]\d{4}|8[0-5]\d{3}|86[0-3]\d{2}|86400)$"}
settings["StickerPrinterCheck"] := {enum: 275, type: "int", section: "Boost", regex: "i)^(0|1)$"}
settings["LastStickerPrinter"] := {enum: 276, type: "int", section: "Boost", regex: "i)^\d{1,10}$"}
settings["AntPassBuyCheck"] := {enum: 277, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["StickerStackHive"] := {enum: 278, type: "int", section: "Boost", regex: "i)^(0|1)$"}
settings["StickerStackCub"] := {enum: 279, type: "int", section: "Boost", regex: "i)^(0|1)$"}
settings["QuestBoostCheck"] := {enum: 280, type: "int", section: "Quests", regex: "i)^(0|1)$"}
settings["MConvertFullBagHarvest"] := {enum: 281, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPlanterGatherA"] := {enum: 282, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPlanterGather1"] := {enum: 283, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPlanterGather2"] := {enum: 284, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPlanterGather3"] := {enum: 285, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPlanterSmoking1"] := {enum: 286, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPlanterSmoking2"] := {enum: 287, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPlanterSmoking3"] := {enum: 288, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPuffModeA"] := {enum: 289, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPuffMode1"] := {enum: 290, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPuffMode2"] := {enum: 291, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["MPuffMode3"] := {enum: 292, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterHarvestNow1"] := {enum: 293, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterHarvestNow2"] := {enum: 294, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterHarvestNow3"] := {enum: 295, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterSS1"] := {enum: 296, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterSS2"] := {enum: 297, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterSS3"] := {enum: 298, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterHarvestTime1"] := {enum: 299, type: "int", section: "Planters", regex: "i)^\d{1,10}$"}
settings["PlanterHarvestTime2"] := {enum: 300, type: "int", section: "Planters", regex: "i)^\d{1,10}$"}
settings["PlanterHarvestTime3"] := {enum: 301, type: "int", section: "Planters", regex: "i)^\d{1,10}$"}
settings["PlanterEstPercent1"] := {enum: 302, type: "int", section: "Planters", regex: "i)^\d{1,3}$"}
settings["PlanterEstPercent2"] := {enum: 303, type: "int", section: "Planters", regex: "i)^\d{1,3}$"}
settings["PlanterEstPercent3"] := {enum: 304, type: "int", section: "Planters", regex: "i)^\d{1,3}$"}
settings["PlanterGlitter1"] := {enum: 305, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterGlitter2"] := {enum: 306, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterGlitter3"] := {enum: 307, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterGlitterC1"] := {enum: 308, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterGlitterC2"] := {enum: 309, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterGlitterC3"] := {enum: 310, type: "int", section: "Planters", regex: "i)^(0|1)$"}
settings["PlanterManualCycle1"] := {enum: 311, type: "int", section: "Planters", regex: "i)^\d$"}
settings["PlanterManualCycle2"] := {enum: 312, type: "int", section: "Planters", regex: "i)^\d$"}
settings["PlanterManualCycle3"] := {enum: 313, type: "int", section: "Planters", regex: "i)^\d$"}
settings["NormalMemoryMatchCheck"] := {enum: 314, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["LastNormalMemoryMatch"] := {enum: 315, type: "int", section: "Collect", regex: "i)^\d{1,10}$"}
settings["MegaMemoryMatchCheck"] := {enum: 316, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["LastMegaMemoryMatch"] := {enum: 317, type: "int", section: "Collect", regex: "i)^\d{1,10}$"}
settings["ExtremeMemoryMatchCheck"] := {enum: 318, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["LastExtremeMemoryMatch"] := {enum: 319, type: "int", section: "Collect", regex: "i)^\d{1,10}$"}
settings["NightMemoryMatchCheck"] := {enum: 320, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["LastNightMemoryMatch"] := {enum: 321, type: "int", section: "Collect", regex: "i)^\d{1,10}$"}
settings["WinterMemoryMatchCheck"] := {enum: 322, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["LastWinterMemoryMatch"] := {enum: 323, type: "int", section: "Collect", regex: "i)^\d{1,10}$"}
settings["MemoryMatchInterruptCheck"] := {enum: 324, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["MicroConverterMatchIgnore"] := {enum: 325, type: "int", section: "Collect"}
settings["SunflowerSeedMatchIgnore"] := {enum: 326, type: "int", section: "Collect"}
settings["JellyBeanMatchIgnore"] := {enum: 327, type: "int", section: "Collect"}
settings["RoyalJellyMatchIgnore"] := {enum: 328, type: "int", section: "Collect"}
settings["TicketMatchIgnore"] := {enum: 329, type: "int", section: "Collect"}
settings["CyanTrimMatchIgnore"] := {enum: 330, type: "int", section: "Collect"}
settings["OilMatchIgnore"] := {enum: 331, type: "int", section: "Collect"}
settings["StrawberryMatchIgnore"] := {enum: 332, type: "int", section: "Collect"}
settings["CoconutMatchIgnore"] := {enum: 333, type: "int", section: "Collect"}
settings["TropicalDrinkMatchIgnore"] := {enum: 334, type: "int", section: "Collect"}
settings["RedExtractMatchIgnore"] := {enum: 335, type: "int", section: "Collect"}
settings["MagicBeanMatchIgnore"] := {enum: 336, type: "int", section: "Collect"}
settings["PineappleMatchIgnore"] := {enum: 337, type: "int", section: "Collect"}
settings["StarJellyMatchIgnore"] := {enum: 338, type: "int", section: "Collect"}
settings["EnzymeMatchMatchIgnore"] := {enum: 339, type: "int", section: "Collect"}
settings["BlueExtractMatchIgnore"] := {enum: 340, type: "int", section: "Collect"}
settings["GumdropMatchIgnore"] := {enum: 341, type: "int", section: "Collect"}
settings["FieldDiceMatchIgnore"] := {enum: 342, type: "int", section: "Collect"}
settings["MoonCharmMatchIgnore"] := {enum: 343, type: "int", section: "Collect"}
settings["BlueberryMatchIgnore"] := {enum: 344, type: "int", section: "Collect"}
settings["GlitterMatchIgnore"] := {enum: 345, type: "int", section: "Collect"}
settings["StingerMatchIgnore"] := {enum: 346, type: "int", section: "Collect"}
settings["TreatMatchIgnore"] := {enum: 347, type: "int", section: "Collect"}
settings["GlueMatchIgnore"] := {enum: 348, type: "int", section: "Collect"}
settings["CloudVialMatchIgnore"] := {enum: 349, type: "int", section: "Collect"}
settings["SoftWaxMatchIgnore"] := {enum: 350, type: "int", section: "Collect"}
settings["HardWaxMatchIgnore"] := {enum: 351, type: "int", section: "Collect"}
settings["SwirledWaxMatchIgnore"] := {enum: 352, type: "int", section: "Collect"}
settings["NightBellMatchIgnore"] := {enum: 353, type: "int", section: "Collect"}
settings["HoneysuckleMatchIgnore"] := {enum: 354, type: "int", section: "Collect"}
settings["SuperSmoothieMatchIgnore"] := {enum: 355, type: "int", section: "Collect"}
settings["SmoothDiceMatchIgnore"] := {enum: 356, type: "int", section: "Collect"}
settings["NeonberryMatchIgnore"] := {enum: 357, type: "int", section: "Collect"}
settings["GingerbreadMatchIgnore"] := {enum: 358, type: "int", section: "Collect"}
settings["SilverEggMatchIgnore"] := {enum: 359, type: "int", section: "Collect"}
settings["GoldEggMatchIgnore"] := {enum: 360, type: "int", section: "Collect"}
settings["DiamondEggMatchIgnore"] := {enum: 361, type: "int", section: "Collect"}
settings["CoconutBoosterCheck"] := {enum: 362, type: "int", section: "Boost", regex: "i)^(0|1)$"}
